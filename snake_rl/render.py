...
CHICK = (247, 243, 231); CHICK_SH = (206, 200, 184); BEAK = (242, 168, 62); EYE = (26, 26, 30)
...
class Renderer:
    ...
    def _blit_sprite(self, surf, pos, off=(0, 0), add=False):
        p = self._p(pos)
    ...
    def _glow(self, pos, r_px):
        self._blit_sprite(self._radial_sprite(r_px, GLOW, 60), pos, add=True)
    ...
    def _draw_chickens(self, world, positions, dirs):
        ...
        for cpos, cdir in zip(positions, dirs):
            ...
            self._glow(cpos, max(10, int(cr * 3.2 * self._scale)))
